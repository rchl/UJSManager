...
function handleRequest(event)
{
  ...
  {
    var tpldata = {
      msg       : request.connection.isLocal ? $('<p class="notifier">If you are the owner of this service, you can go to <a href="' + SERVICE_PATH_ADMIN + '" onclick="location.replace(this.href);return false;">Admin section</a></p>') : '',
